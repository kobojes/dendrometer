...
dendro_abs <- read.csv("dendro_all_cf10new_abs.csv",header = T,sep=",")
dendro_diff <- read.csv("dendro_all_cf10new_diff.csv",header = T,sep=",")
...
plot(Date_Time.px,SF1_L6_dia.c,type="l", col=4, xaxt="n",
     xlab="Date",ylab="acc. radius change (mm)", xlim=c(start_date,end_date),ylim=c(0,3),lwd=2)
abline(h=0); abline(v=jan1_2013,lty=2);abline(v=jan1_2014,lty=2)
axis.POSIXct(1, at=seq(start_date.axis,end_date, by="months"), format="%Y-%m",cex.axis=0.8) #label the x axis by months (day of tick depends on starting date)
# dev.off() 
...
d.start_date <- as.POSIXct(as.Date("2013-08-01 00:00", format="%Y-%m-%d %H:%M"))
d.end_date <- as.POSIXct(as.Date("2013-08-02 12:00", format="%Y-%m-%d %H:%M"))
d.start_date.axis <- as.POSIXct(as.Date("2013-08-01 00:00", format="%Y-%m-%d %H:%M"))

# win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro_SF3_L4_daily.emf", height=3, width=4, pointsize=15)
par(mfcol=c(1,1), mar=c(1,3,1,0),oma=c(1,1,0.5,0.5),mgp=c(2,0.5,0),tcl=-0.2) # 
plot(Date_Time.px,SF3_L4_dia.c,type="l", col=2, xaxt="n",
     xlab="Date",ylab="acc. radius change (mm)", xlim=c(d.start_date,d.end_date),ylim=c(2.1,2.2),lwd=2)
...
# only one day
# win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro_SF3_L4_daily2.emf", height=3, width=4, pointsize=15)
par(mfcol=c(1,1), mar=c(1,3,1,0),oma=c(1,1,0.5,0.5),mgp=c(2,0.5,0),tcl=-0.2) # 
plot(Date_Time.px,SF3_L4_dia.c,type="l", col=2, xaxt="n",
     xlab="Date",ylab="acc. radius change (mm)", xlim=c(d.start_date,d.end_date),ylim=c(2.1,2.2),lwd=2)
axis.POSIXct(1, at=seq(d.start_date.axis,d.end_date, by="hours"), format="%H",cex.axis=0.8) #label the x axis by months (day of tick depends on starting date)
# dev.off() 
...
par(mfcol=c(1,1), mar=c(1,3,1,0),oma=c(1,1,0.5,0.5),mgp=c(2,0.5,0),tcl=-0.2) # 
plot(Date_Time.px,SF1_L6_dia.c,type="l", col=4, xaxt="n",
     xlab="Date",ylab="acc. radius change (mm)", xlim=c(w.start_date,w.end_date),ylim=c(1.9,2.4),lwd=2)
...
plot(Date_Time.px,SF1_L2_dia.c,type="l", col=1, xaxt="n",
     xlab="Date",ylab="acc. radius change (mm)", xlim=c(start_date,end_date),ylim=c(-1,8),lwd=2)
...
# calculate and plot site means ##### 
# => does not function: check calculation of yearly values for SF4 and SF5, calculation via differences to avoid problems when one data series is missing? 
summary(data_dendro2012.1.0)
data_dendro2012.1.0$mean_SF1 <- rowMeans(data_dendro2012.1.0[,c("SF1_L2_dia.c","SF1_L4_dia.c","SF1_L5_dia.c","SF1_L6_dia.c")],na.rm = TRUE)
data_dendro2012.1.0$mean_SF2 <- rowMeans(data_dendro2012.1.0[,c("SF2_L1_dia.c","SF2_L4_dia.c","SF2_L5_dia.c","SF2_L7_dia.c")],na.rm = TRUE)
data_dendro2012.1.0$mean_SF3 <- rowMeans(data_dendro2012.1.0[,c("SF3_L3_dia.c","SF3_L4_dia.c","SF3_L5_dia.c","SF3_L6_dia.c")],na.rm = TRUE)
data_dendro2012.1.0$mean_SF4L <- rowMeans(data_dendro2012.1.0[,c("SF4_L1_dia.c","SF4_L2_dia.c","SF4_L3_dia.c","SF4_L4_dia.c")],na.rm = TRUE)
data_dendro2012.1.0$mean_SF4Z <- rowMeans(data_dendro2012.1.0[,c("SF4_Z1_dia.c","SF4_Z2_dia.c","SF4_Z3_dia.c","SF4_Z4_dia.c")],na.rm = TRUE)
data_dendro2012.1.0$mean_SF5L <- rowMeans(data_dendro2012.1.0[,c("SF5_L1_dia.c","SF5_L2_dia.c","SF5_L3_dia.c","SF5_L4_dia.c")],na.rm = TRUE)
data_dendro2012.1.0$mean_SF5Z <- rowMeans(data_dendro2012.1.0[,c("SF5_Z1_dia.c","SF5_Z2_dia.c","SF5_Z3_dia.c","SF5_Z4_dia.c")],na.rm = TRUE)

# Plot variables of hourly dendrometer-data data_dendro2012.1.0 (2012.1 values starting at 2012.1-04-10)
# win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2012.1_radius_mean_SF1-5_d.emf", height=5, width=4, pointsize=15)
par(mfcol=c(1,1), mar=c(1,3,1,0),oma=c(1,1,0.5,0.5),mgp=c(2,0.5,0),tcl=-0.2) # 
plot(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$mean_SF1,type="l", col=1, xaxt="n",
     #     xlab="Date",ylab="",xlim=c(start_2012.1,end_2012.1.2),ylim=c(-1,4.5),lwd=2) # ylab="acc. radius change(mm)", 
     xlab="Datum",ylab="",xlim=c(start_2012.1,end_2012),ylim=c(-1,4.5),lwd=2) # ylab="Zuwachs (mm Radius)", 
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$mean_SF2,col=2,lty=1,lwd=2)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$mean_SF3,col=3,lty=1,lwd=2)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$mean_SF4L,col=4,lty=1,lwd=2)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$mean_SF4Z,col=4,lty=2,lwd=2)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$mean_SF5L,col=5,lty=1,lwd=2)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$mean_SF5Z,col=5,lty=2,lwd=2)
abline(h=0)
axis.POSIXct(1, at=seq(axis_2012,end_2012, by="months"), format="%Y-%m",cex.axis=0.8) #label the x axis by months
# legend("topleft",c("SF1","SF2","SF3"),pch=15,col=c(1,2,3),cex=0.8,bty="n",title="Site")
legend("topleft",c("SF1","SF2","SF3"),pch=15,col=c(1,2,3),cex=0.8,bty="n",title="Messfläche")
...
summary(data_dendro2013.0)
data_dendro2013.0$mean_SF1 <- rowMeans(data_dendro2013.0[,c("SF1_L2_dia.c","SF1_L4_dia.c","SF1_L5_dia.c","SF1_L6_dia.c")],na.rm = TRUE)
data_dendro2013.0$mean_SF2 <- rowMeans(data_dendro2013.0[,c("SF2_L1_dia.c","SF2_L4_dia.c","SF2_L5_dia.c","SF2_L7_dia.c")],na.rm = TRUE)
data_dendro2013.0$mean_SF3 <- rowMeans(data_dendro2013.0[,c("SF3_L3_dia.c","SF3_L4_dia.c","SF3_L5_dia.c","SF3_L6_dia.c")],na.rm = TRUE)
data_dendro2013.0$mean_SF4L <- rowMeans(data_dendro2013.0[,c("SF4_L1_dia.c","SF4_L2_dia.c","SF4_L3_dia.c","SF4_L4_dia.c")],na.rm = TRUE)
data_dendro2013.0$mean_SF4Z <- rowMeans(data_dendro2013.0[,c("SF4_Z1_dia.c","SF4_Z2_dia.c","SF4_Z3_dia.c","SF4_Z4_dia.c")],na.rm = TRUE)
data_dendro2013.0$mean_SF5L <- rowMeans(data_dendro2013.0[,c("SF5_L1_dia.c","SF5_L2_dia.c","SF5_L3_dia.c","SF5_L4_dia.c")],na.rm = TRUE)
data_dendro2013.0$mean_SF5Z <- rowMeans(data_dendro2013.0[,c("SF5_Z1_dia.c","SF5_Z2_dia.c","SF5_Z3_dia.c","SF5_Z4_dia.c")],na.rm = TRUE)

# Plot variables of hourly dendrometer-data data_dendro2013.0 (2013 values starting at 2013-04-10)
# win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2013_radius_mean_SF1-5_d.emf", height=5, width=4, pointsize=15)
par(mfcol=c(1,1), mar=c(1,3,1,0),oma=c(1,1,0.5,0.5),mgp=c(2,0.5,0),tcl=-0.2) # 
plot(data_dendro2013.0$Date_Time.px,data_dendro2013.0$mean_SF1,type="l", col=1, xaxt="n",
     #     xlab="Date",ylab="",xlim=c(start_2013,end_2013.2),ylim=c(-1,4.5),lwd=2) # ylab="acc. radius change(mm)", 
     xlab="Datum",ylab="",xlim=c(start_2013,end_2013),ylim=c(-1,4.5),lwd=2) # ylab="Zuwachs (mm Radius)", 
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$mean_SF2,col=2,lty=1,lwd=2)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$mean_SF3,col=3,lty=1,lwd=2)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$mean_SF4L,col=4,lty=1,lwd=2)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$mean_SF4Z,col=4,lty=2,lwd=2)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$mean_SF5L,col=5,lty=1,lwd=2)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$mean_SF5Z,col=5,lty=2,lwd=2)
abline(h=0)
axis.POSIXct(1, at=seq(axis_2013,end_2013, by="months"), format="%Y-%m",cex.axis=0.8) #label the x axis by months
# legend("topleft",c("SF1","SF2","SF3"),pch=15,col=c(1,2,3),cex=0.8,bty="n",title="Site")
legend("topleft",c("SF1","SF2","SF3"),pch=15,col=c(1,2,3),cex=0.8,bty="n",title="Messfläche")
...
summary(data_dendro2014.0)
data_dendro2014.0$mean_SF1 <- rowMeans(data_dendro2014.0[,c("SF1_L2_dia.c","SF1_L4_dia.c","SF1_L5_dia.c","SF1_L6_dia.c")],na.rm = TRUE)
data_dendro2014.0$mean_SF2 <- rowMeans(data_dendro2014.0[,c("SF2_L1_dia.c","SF2_L4_dia.c","SF2_L5_dia.c","SF2_L7_dia.c")],na.rm = TRUE)
data_dendro2014.0$mean_SF3 <- rowMeans(data_dendro2014.0[,c("SF3_L3_dia.c","SF3_L4_dia.c","SF3_L5_dia.c","SF3_L6_dia.c")],na.rm = TRUE)
data_dendro2014.0$mean_SF4L <- rowMeans(data_dendro2014.0[,c("SF4_L1_dia.c","SF4_L2_dia.c","SF4_L3_dia.c","SF4_L4_dia.c")],na.rm = TRUE)
data_dendro2014.0$mean_SF4Z <- rowMeans(data_dendro2014.0[,c("SF4_Z1_dia.c","SF4_Z2_dia.c","SF4_Z3_dia.c","SF4_Z4_dia.c")],na.rm = TRUE)
data_dendro2014.0$mean_SF5L <- rowMeans(data_dendro2014.0[,c("SF5_L1_dia.c","SF5_L2_dia.c","SF5_L3_dia.c","SF5_L4_dia.c")],na.rm = TRUE)
data_dendro2014.0$mean_SF5Z <- rowMeans(data_dendro2014.0[,c("SF5_Z1_dia.c","SF5_Z2_dia.c","SF5_Z3_dia.c","SF5_Z4_dia.c")],na.rm = TRUE)

# Plot variables of hourly dendrometer-data data_dendro2014.0 (2014 values starting at 2014-04-10)
# win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2014_radius_mean_SF1-5_d.emf", height=5, width=4, pointsize=15)
par(mfcol=c(1,1), mar=c(1,3,1,0),oma=c(1,1,0.5,0.5),mgp=c(2,0.5,0),tcl=-0.2) # 
plot(data_dendro2014.0$Date_Time.px,data_dendro2014.0$mean_SF1,type="l", col=1, xaxt="n",
     #     xlab="Date",ylab="",xlim=c(start_2014,end_2014.2),ylim=c(-1,4.5),lwd=2) # ylab="acc. radius change(mm)", 
     xlab="Datum",ylab="",xlim=c(start_2014,end_2014.2),ylim=c(-1,4.5),lwd=2) # ylab="Zuwachs (mm Radius)", 
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$mean_SF2,col=2,lty=1,lwd=2)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$mean_SF3,col=3,lty=1,lwd=2)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$mean_SF4L,col=4,lty=1,lwd=2)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$mean_SF4Z,col=4,lty=2,lwd=2)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$mean_SF5L,col=5,lty=1,lwd=2)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$mean_SF5Z,col=5,lty=2,lwd=2)
abline(h=0)
axis.POSIXct(1, at=seq(axis_2014,end_2014.2, by="months"), format="%Y-%m",cex.axis=0.8) #label the x axis by months
# legend("topleft",c("SF1","SF2","SF3"),pch=15,col=c(1,2,3),cex=0.8,bty="n",title="Site")
legend("topleft",c("SF1","SF2","SF3"),pch=15,col=c(1,2,3),cex=0.8,bty="n",title="Messfläche")
...
plot(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF1_L2_dia.c,type="l", col=3, xaxt="n",
     xlab="Date",ylab="acc. radius change (mm)",xlim=c(start_2012.1,end_2012),ylim=c(-1,4.5),lwd=2) # ylab="acc. radius change(mm)", 
...
legend("topleft",c("54","35","25","21"),
       pch=15,col=c(1,2,3,4),cex=0.8,bty="n",title="DBH (cm)")
title("SF1-2012")
# dev.off() 
...
plot(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF2_L1_dia.c,type="l", col=1, xaxt="n",
     xlab="Date",ylab="",xlim=c(start_2012.1,end_2012),ylim=c(-1,4.5),lwd=2) # ylab="acc. radius change(mm)", 
...
plot(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF1_L2_dia.c,type="l", col=3, xaxt="n",
     xlab="Date",ylab="acc. radius change (mm)",xlim=c(start_2013,end_2013),ylim=c(-1,4.5),lwd=2) # ylab="acc. radius change(mm)", 
...
plot(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF1_L2_dia.c,type="l", col=3, xaxt="n",
     xlab="Date",ylab="acc. radius change (mm)",xlim=c(start_2014,end_2014.2),ylim=c(-1,4.5),lwd=2) # ylab="acc. radius change(mm)", 
...
for (i in 1:44){
  ...
  plot(x=dendro_r.i$Date_Time.px,y=dendro_r.i$SF1_L6_dia.c,type="l",col=4,xaxt="n",
       xlab="Date",ylab="acc. acc. radius change(mm)",
