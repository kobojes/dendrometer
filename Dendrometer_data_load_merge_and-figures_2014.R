...
end_date <- as.POSIXct(as.Date("2014-11-15", format="%Y-%m-%d"))
...
plot(Date_Time.px,SF1_L2_dia.c,type="l", col=1, xaxt="n",
     xlab="Date",ylab="radius variation (mm)", xlim=c(start_date,end_date),ylim=c(-1,10))
lines(Date_Time.px,SF1_L4_dia.c,col=2)
lines(Date_Time.px,SF1_L5_dia.c,col=3)
lines(Date_Time.px,SF1_L6_dia.c,col=4)
abline(h=0); abline(v=jan1_2013,lty=2);abline(v=jan1_2014,lty=2)
axis.POSIXct(1, at=seq(start_date.axis,end_date, by="months"), format="%Y-%m",cex.axis=0.8) #label the x axis by months (day of tick depends on starting date)
legend("topleft",c("L2 (DBH 24.5 cm)","L4 (DBH 35.3 cm)","L5 (DBH 20.7 cm)","L6 (DBH 53.5 cm)"),
...
plot(Date_Time.px,SF2_L1_dia.c,type="l", col=1, xaxt="n",
     xlab="Date",ylab="radius variation (mm)", xlim=c(start_date,end_date),ylim=c(-1,10))
lines(Date_Time.px,SF2_L4_dia.c,col=2)
lines(Date_Time.px,SF2_L5_dia.c,col=3)
lines(Date_Time.px,SF2_L7_dia.c,col=4)
abline(h=0); abline(v=jan1_2013,lty=2);abline(v=jan1_2014,lty=2)
axis.POSIXct(1, at=seq(start_date.axis,end_date, by="months"), format="%Y-%m",cex.axis=0.8) #label the x axis by months
legend("topleft",c("L1 (DBH 49.2 cm)","L4 (DBH 37.2 cm)","L5 (DBH 43.1 cm)","L7 (DBH 29.9 cm)"),
       pch=15,col=c(1,2,3,4),cex=0.8,bty="n")
...
plot(Date_Time.px,SF3_L3_dia.c,type="l", col=1, xaxt="n",
     xlab="Date",ylab="radius variation (mm)", xlim=c(start_date,end_date),ylim=c(-1,10))
lines(Date_Time.px,SF3_L4_dia.c,col=2)
lines(Date_Time.px,SF3_L5_dia.c,col=3)
lines(Date_Time.px,SF3_L6_dia.c,col=4)
abline(h=0); abline(v=jan1_2013,lty=2);abline(v=jan1_2014,lty=2)
axis.POSIXct(1, at=seq(start_date.axis,end_date, by="months"), format="%Y-%m",cex.axis=0.8) #label the x axis by months
legend("topleft",c("L3 (DBH 56.0 cm)","L4 (DBH 44.6 cm)","L5 (DBH 36.0 cm)","L6 (DBH 31.2 cm)"),
       pch=15,col=c(1,2,3,4),cex=0.8,bty="n")
...
start_2014<-as.POSIXct(as.Date("2014-04-10 0:10", format="%Y-%m-%d %H:%M"))
...
end_2014.2<-as.POSIXct(as.Date("2014-11-15 0:00", format="%Y-%m-%d %H:%M"))
...
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF1_L4_dia.c,col=1,lty=2)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF1_L5_dia.c,col=1,lty=3)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF1_L6_dia.c,col=1,lty=4)

lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF2_L1_dia.c,col=2,lty=1)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF2_L4_dia.c,col=2,lty=2)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF2_L5_dia.c,col=2,lty=3)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF2_L7_dia.c,col=2,lty=4)

lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF3_L3_dia.c,col=3,lty=1)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF3_L4_dia.c,col=3,lty=2)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF3_L5_dia.c,col=3,lty=3)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF3_L6_dia.c,col=3,lty=4)

lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF4_L1_dia.c,col=4,lty=1)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF4_L2_dia.c,col=4,lty=2)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF4_L3_dia.c,col=4,lty=3)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF4_L4_dia.c,col=4,lty=4)

lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF5_L1_dia.c,col=5,lty=1)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF5_L2_dia.c,col=5,lty=2)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF5_L3_dia.c,col=5,lty=3)
lines(data_dendro2012.1.0$Date_Time.px,data_dendro2012.1.0$SF5_L4_dia.c,col=5,lty=4)
...
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF1_L4_dia.c,col=1,lty=2)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF1_L5_dia.c,col=1,lty=3)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF1_L6_dia.c,col=1,lty=4)

lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF2_L1_dia.c,col=2,lty=1)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF2_L4_dia.c,col=2,lty=2)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF2_L5_dia.c,col=2,lty=3)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF2_L7_dia.c,col=2,lty=4)

lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF3_L3_dia.c,col=3,lty=1)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF3_L4_dia.c,col=3,lty=2)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF3_L5_dia.c,col=3,lty=3)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF3_L6_dia.c,col=3,lty=4)

lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF4_L1_dia.c,col=4,lty=1)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF4_L2_dia.c,col=4,lty=2)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF4_L3_dia.c,col=4,lty=3)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF4_L4_dia.c,col=4,lty=4)

lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF5_L1_dia.c,col=5,lty=1)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF5_L2_dia.c,col=5,lty=2)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF5_L3_dia.c,col=5,lty=3)
lines(data_dendro2013.0$Date_Time.px,data_dendro2013.0$SF5_L4_dia.c,col=5,lty=4)
...
plot(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF1_L2_dia.c,type="l", col=1, xaxt="n",
     xlab="Date",ylab="radius variation (mm)", xlim=c(start_2014,end_2014.2),ylim=c(-1,4.5))
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF1_L4_dia.c,col=1,lty=2)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF1_L5_dia.c,col=1,lty=3)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF1_L6_dia.c,col=1,lty=4)

lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF2_L1_dia.c,col=2,lty=1)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF2_L4_dia.c,col=2,lty=2)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF2_L5_dia.c,col=2,lty=3)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF2_L7_dia.c,col=2,lty=4)

lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF3_L3_dia.c,col=3,lty=1)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF3_L4_dia.c,col=3,lty=2)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF3_L5_dia.c,col=3,lty=3)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF3_L6_dia.c,col=3,lty=4)

lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF4_L1_dia.c,col=4,lty=1)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF4_L2_dia.c,col=4,lty=2)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF4_L3_dia.c,col=4,lty=3)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF4_L4_dia.c,col=4,lty=4)

lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF5_L1_dia.c,col=5,lty=1)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF5_L2_dia.c,col=5,lty=2)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF5_L3_dia.c,col=5,lty=3)
lines(data_dendro2014.0$Date_Time.px,data_dendro2014.0$SF5_L4_dia.c,col=5,lty=4)

abline(h=0)
axis.POSIXct(1, at=seq(start_2014,end_2014.2, by="months"), format="%Y-%m",cex.axis=0.8) #label the x axis by months
legend("topleft",c("SF1","SF2","SF3","SF4","SF5"),
       pch=15,col=c(1,2,3,4,5),cex=0.8,bty="n",title="Site")
title("Dendrometer (hourly) 2014 all trees + sites")
