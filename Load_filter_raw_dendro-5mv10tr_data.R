...
SF1_L2_dia_diff.c <-ifelse(SF1_L2_dia_diff > 1,NA,SF1_L2_dia_diff) 
SF1_L2_dia_diff.c <-ifelse(SF1_L2_dia_diff.c < -1,NA,SF1_L2_dia_diff.c) 
...
SF1_L4_dia_diff.c <-ifelse(SF1_L4_dia_diff > 1,NA,SF1_L4_dia_diff) 
SF1_L4_dia_diff.c <-ifelse(SF1_L4_dia_diff.c < -1,NA,SF1_L4_dia_diff.c) 
...
SF1_L5_dia_diff.c <-ifelse(SF1_L5_dia_diff > 1,NA,SF1_L5_dia_diff) 
SF1_L5_dia_diff.c <-ifelse(SF1_L5_dia_diff.c < -1,NA,SF1_L5_dia_diff.c) 
...
SF1_L6_dia_diff.c <-ifelse(SF1_L6_dia_diff > 1,NA,SF1_L6_dia_diff) 
SF1_L6_dia_diff.c <-ifelse(SF1_L6_dia_diff.c < -1,NA,SF1_L6_dia_diff.c) 
...
win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2012-2014_SF1_cleared_5mv_Trs_10.emf", height=12, width=12, pointsize=14)
...
win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2012-2014_SF1_comp_raw-cleared_5mv_Trs_10.emf", height=12, width=12, pointsize=14)
...
SF2_L1_dia_diff.c <-ifelse(SF2_L1_dia_diff > 1,NA,SF2_L1_dia_diff) 
SF2_L1_dia_diff.c <-ifelse(SF2_L1_dia_diff.c < -1,NA,SF2_L1_dia_diff.c) 
...
SF2_L4_dia_diff.c <-ifelse(SF2_L4_dia_diff > 1,NA,SF2_L4_dia_diff) 
SF2_L4_dia_diff.c <-ifelse(SF2_L4_dia_diff.c < -1,NA,SF2_L4_dia_diff.c) 
...
SF2_L5_dia_diff.c <-ifelse(SF2_L5_dia_diff > 1,NA,SF2_L5_dia_diff) 
SF2_L5_dia_diff.c <-ifelse(SF2_L5_dia_diff.c < -1,NA,SF2_L5_dia_diff.c) 
...
SF2_L7_dia_diff.c <-ifelse(SF2_L7_dia_diff > 1,NA,SF2_L7_dia_diff) 
SF2_L7_dia_diff.c <-ifelse(SF2_L7_dia_diff.c < -1,NA,SF2_L7_dia_diff.c) 
...
win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2012-2014_SF2_cleared_Trs_10.emf", height=8, width=12, pointsize=14)
par(mfcol=c(3,1), mar=c(3,3,3,2), oma=c(2,2,2,1), mgp=c(2,1,0),tcl=-0.2)
...
win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2012-2014_SF2_comp_raw-cleared_Trs_10.emf", height=12, width=12, pointsize=14)
par(mfcol=c(4,1), mar=c(3,3,3,2), oma=c(2,2,2,1), mgp=c(2,1,0),tcl=-0.2)
...
SF3_L3_dia_diff.c <-ifelse(SF3_L3_dia_diff > 1,NA,SF3_L3_dia_diff) 
SF3_L3_dia_diff.c <-ifelse(SF3_L3_dia_diff.c < -1,NA,SF3_L3_dia_diff.c) 
...
SF3_L4_dia_diff.c <-ifelse(SF3_L4_dia_diff > 1,NA,SF3_L4_dia_diff) 
SF3_L4_dia_diff.c <-ifelse(SF3_L4_dia_diff.c < -1,NA,SF3_L4_dia_diff.c) 
...
SF3_L5_dia_diff.c <-ifelse(SF3_L5_dia_diff > 1,NA,SF3_L5_dia_diff) 
SF3_L5_dia_diff.c <-ifelse(SF3_L5_dia_diff.c < -1,NA,SF3_L5_dia_diff.c) 
...
SF3_L6_dia_diff.c <-ifelse(SF3_L6_dia_diff > 1,NA,SF3_L6_dia_diff) 
SF3_L6_dia_diff.c <-ifelse(SF3_L6_dia_diff.c < -1,NA,SF3_L6_dia_diff.c) 
...
win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2012-2014_SF3_comp_raw-cleared_Trs_10.emf", height=12, width=12, pointsize=14)
par(mfcol=c(4,1), mar=c(3,3,3,2), oma=c(2,2,2,1), mgp=c(2,1,0),tcl=-0.2)
...
SF4_L1_dia_diff.c <-ifelse(SF4_L1_dia_diff > 1,NA,SF4_L1_dia_diff) 
SF4_L1_dia_diff.c <-ifelse(SF4_L1_dia_diff.c < -1,NA,SF4_L1_dia_diff.c) 
...
SF4_L2_dia_diff.c <-ifelse(SF4_L2_dia_diff > 1,NA,SF4_L2_dia_diff) 
SF4_L2_dia_diff.c <-ifelse(SF4_L2_dia_diff.c < -1,NA,SF4_L2_dia_diff.c) 
...
SF4_L3_dia_diff.c <-ifelse(SF4_L3_dia_diff > 1,NA,SF4_L3_dia_diff) 
SF4_L3_dia_diff.c <-ifelse(SF4_L3_dia_diff.c < -1,NA,SF4_L3_dia_diff.c) 
...
SF4_L4_dia_diff.c <-ifelse(SF4_L4_dia_diff > 1,NA,SF4_L4_dia_diff) 
SF4_L4_dia_diff.c <-ifelse(SF4_L4_dia_diff.c < -1,NA,SF4_L4_dia_diff.c) 
...
win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2012-2014_SF4_comp_raw-cleared_Trs_10.emf", height=12, width=12, pointsize=14)
par(mfcol=c(4,1), mar=c(3,3,3,2), oma=c(2,2,2,1), mgp=c(2,1,0),tcl=-0.2)
...
SF4_Z1_dia_diff.c <-ifelse(SF4_Z1_dia_diff > 1,NA,SF4_Z1_dia_diff) 
SF4_Z1_dia_diff.c <-ifelse(SF4_Z1_dia_diff.c < -1,NA,SF4_Z1_dia_diff.c) 
...
SF4_Z2_dia_diff.c <-ifelse(SF4_Z2_dia_diff > 1,NA,SF4_Z2_dia_diff) 
SF4_Z2_dia_diff.c <-ifelse(SF4_Z2_dia_diff.c < -1,NA,SF4_Z2_dia_diff.c) 
...
SF4_Z3_dia_diff.c <-ifelse(SF4_Z3_dia_diff > 1,NA,SF4_Z3_dia_diff) 
SF4_Z3_dia_diff.c <-ifelse(SF4_Z3_dia_diff.c < -1,NA,SF4_Z3_dia_diff.c) 
...
SF4_Z4_dia_diff.c <-ifelse(SF4_Z4_dia_diff > 1,NA,SF4_Z4_dia_diff) 
SF4_Z4_dia_diff.c <-ifelse(SF4_Z4_dia_diff.c < -1,NA,SF4_Z4_dia_diff.c) 
...
win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2012-2014_SF4Z_comp_raw-cleared_Trs_10.emf", height=12, width=12, pointsize=14)
par(mfcol=c(4,1), mar=c(3,3,3,2), oma=c(2,2,2,1), mgp=c(2,1,0),tcl=-0.2)
...
SF5_L1_dia_diff.c <-ifelse(SF5_L1_dia_diff > 1,NA,SF5_L1_dia_diff) 
SF5_L1_dia_diff.c <-ifelse(SF5_L1_dia_diff.c < -1,NA,SF5_L1_dia_diff.c) 
...
SF5_L2_dia_diff.c <-ifelse(SF5_L2_dia_diff > 1,NA,SF5_L2_dia_diff) 
SF5_L2_dia_diff.c <-ifelse(SF5_L2_dia_diff.c < -1,NA,SF5_L2_dia_diff.c) 
...
SF5_L3_dia_diff.c <-ifelse(SF5_L3_dia_diff > 1,NA,SF5_L3_dia_diff) 
SF5_L3_dia_diff.c <-ifelse(SF5_L3_dia_diff.c < -1,NA,SF5_L3_dia_diff.c) 
...
SF5_L4_dia_diff.c <-ifelse(SF5_L4_dia_diff > 1,NA,SF5_L4_dia_diff) 
SF5_L4_dia_diff.c <-ifelse(SF5_L4_dia_diff.c < -1,NA,SF5_L4_dia_diff.c) 
...
win.metafile("H:/Data/Matsch_Catchment/SF/figures_dendro/Dendro2012-2014_SF5_comp_raw-cleared_Trs_10.emf", height=12, width=12, pointsize=14)
par(mfcol=c(4,1), mar=c(3,3,3,2), oma=c(2,2,2,1), mgp=c(2,1,0),tcl=-0.2)
...
SF5_Z1_dia_diff.c <-ifelse(SF5_Z1_dia_diff > 1,NA,SF5_Z1_dia_diff) 
SF5_Z1_dia_diff.c <-ifelse(SF5_Z1_dia_diff.c < -1,NA,SF5_Z1_dia_diff.c) 
...
SF5_Z2_dia_diff.c <-ifelse(SF5_Z2_dia_diff > 1,NA,SF5_Z2_dia_diff) 
SF5_Z2_dia_diff.c <-ifelse(SF5_Z2_dia_diff.c < -1,NA,SF5_Z2_dia_diff.c) 
...
SF5_Z3_dia_diff.c <-ifelse(SF5_Z3_dia_diff > 1,NA,SF5_Z3_dia_diff) 
SF5_Z3_dia_diff.c <-ifelse(SF5_Z3_dia_diff.c < -1,NA,SF5_Z3_dia_diff.c) 
...
SF5_Z4_dia_diff.c <-ifelse(SF5_Z4_dia_diff > 1,NA,SF5_Z4_dia_diff) 
SF5_Z4_dia_diff.c <-ifelse(SF5_Z4_dia_diff.c < -1,NA,SF5_Z4_dia_diff.c) 
...
outfile.dendro_abs <- ("H:/Data/Matsch_Catchment/SF/dendro files for R/dendro_all_cf10_abs.csv")  
write.csv(exp_dendro_abs,file=outfile.dendro_abs)

outfile.dendro_diff <- ("H:/Data/Matsch_Catchment/SF/dendro files for R/dendro_all_cf10_diff.csv")  
